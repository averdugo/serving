        ...
        <section>
            ...
            <div class="main-content" >
                ...
                <div class="wrapper">
                    <div class="row">
                        <div class="col-md-12">
                            <h4 class="fw-title">Formulario Creacion Bch</h4>
                                    ...
                                    <div class="widget-block">
                                        <div class="widget-content box-padding">
                                            ...
                                            <fieldset title="Paso 1">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 col-sm-2 control-label">Tipo</label>
                                                    <div class="col-md-6 col-sm-6">
                                                        <select name="detail_type" id="" class="form-control" >
                                                            @include('partials.typeDtSelect')
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-2 col-sm-2 control-label">Tarea</label>
                                                    <div class="col-md-6 col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        <select name="status" id="" class="form-control" >
                                                            @include('partials.statusDtSelect')
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <fieldset title="Paso 2">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 col-sm-2 control-label">Nombre Ingeniero Dt</label>
                                                    <div class="col-md-6 col-sm-6">
